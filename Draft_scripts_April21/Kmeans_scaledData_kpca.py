# -*- coding: utf-8 -*-
"""
Created on Tue Apr 16 22:58:30 2019
...
adjusted_rand_score = metrics.adjusted_rand_score(y_true, y_kpcaData)
a = print('Adjusted rand score for KMeans using KernelPCA {}.'.format(adjusted_rand_score))

homogeneity_score, completeness_score, V_score = metrics.homogeneity_completeness_v_measure(y_true, y_kpcaData)
