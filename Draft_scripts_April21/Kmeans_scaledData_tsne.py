# -*- coding: utf-8 -*-
"""
Created on Tue Apr 16 23:03:17 2019
...
tsne = TSNE(n_components = 2, perplexity = 9, n_iter = 200000, n_iter_without_progress = 300, init = 'pca')
X_train = tsne.fit_transform(sc_X)
...
adjusted_rand_score = metrics.adjusted_rand_score(y_true, y_tsneData)
a = print('Adjusted rand score for KMeans using KernelPCA {}.'.format(adjusted_rand_score))

homogeneity_score, completeness_score, V_score = metrics.homogeneity_completeness_v_measure(y_true, y_tsneData)
