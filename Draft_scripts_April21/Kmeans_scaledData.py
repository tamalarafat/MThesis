# -*- coding: utf-8 -*-
"""
Created on Tue Apr 16 19:31:14 2019
...
y_scaledData = kmeans.fit_predict(sc_X)

adjusted_rand_score = metrics.adjusted_rand_score(y_true, y_scaledData)
a = print('Adjusted rand score for KMeans using KernelPCA {}.'.format(adjusted_rand_score))

homogeneity_score, completeness_score, V_score = metrics.homogeneity_completeness_v_measure(y_true, y_scaledData)
