...
# #plt.savefig('KPCA_26to29PCS_6pcs_200.png')   
# plt.tight_layout()  
# =============================================================================
#3 principal components separates the data point more correctly than more or less components
...
plt.savefig('1. KPCA_Transformed_with3Pcs_from6PCAs_200genes.png')
plt.show()
...
for i, txt in enumerate(sample_label):
    ax.annotate(txt, (kpca_transformed[:,0][i], kpca_transformed[:,1][i]))
plt.savefig('1. KPCA_KMeans_with3Pcs_from6PCAs_200genes.png')
plt.show()
...
fig.suptitle('KernelPCA with 3PCs from 6 PCAs and 1200 genes')
fig.savefig('1. KPCA_with3Pcs_from6PCAs_200genes.png')
...
plt.savefig('1. TSNE_Transformed_with2Pcs_from6PCAs_200genes.png')
plt.show()
...
for i, txt in enumerate(sample_label):
    ax.annotate(txt, (tsne_transformed[:,0][i], tsne_transformed[:,1][i]))
plt.savefig('1. TSNE_clustered_with2Pcs_from6PCAs_200genes.png')
plt.show()
...
fig.suptitle('TSNE with 2PCs from 6 PCAs and 1200 genes')
fig.savefig('1. TSNE_with2Pcs_from6PCAs_200genes.png')
fig.subplots_adjust(hspace = 0.1, wspace = 0.1)
plt.tight_layout()
plt.show()
