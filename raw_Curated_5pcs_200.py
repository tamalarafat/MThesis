...
# #plt.savefig('KPCA_4to7PCS_5pcs_200.png')   
# plt.tight_layout()  
# =============================================================================
...
plt.savefig('3. KPCA_Transformed_with5Pcs_from5PCAs_200genes.png')
plt.show()
...
for i, txt in enumerate(sample_label):
    ax.annotate(txt, (kpca_transformed[:,0][i], kpca_transformed[:,1][i]))
plt.savefig('3. KPCA_KMeans_with5Pcs_from5PCAs_200genes.png')
plt.show()
...
fig.suptitle('KernelPCA with 5PCs from 5 PCAs and 1000 genes')
fig.subplots_adjust(hspace = 0.1, wspace = 0.1)
plt.tight_layout()
fig.savefig('3. KPCA_with5Pcs_from5PCAs_200genes.png')
plt.show()
...
plt.savefig('3. TSNE_Transformed_with2Pcs_from5PCAs_200genes.png')
plt.show()
...
for i, txt in enumerate(sample_label):
    ax.annotate(txt, (tsne_transformed[:,0][i], tsne_transformed[:,1][i]))
plt.savefig('3. TSNE_clustered_with2Pcs_from5PCAs_200genes.png')
plt.show()
...
fig.suptitle('TSNE with 2PCs from 5 PCAs and 1000 genes')
fig.subplots_adjust(hspace = 0.1, wspace = 0.1)
plt.tight_layout()
fig.savefig('3. TSNE_with2Pcs_from5PCAs_200genes.png')
plt.show()
